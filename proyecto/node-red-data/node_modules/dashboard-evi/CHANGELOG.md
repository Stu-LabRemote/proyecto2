...
**Enhancements**
 ...
 - Allow `ui.middleware` in settings.js to specify middleware for use with dashboard endpoint. See [PR #209](https://github.com/node-red/dashboard-evi/pull/209/) for example usage.
...
**Enhancements**
 ...
 - Add PR to allow pluggable widgets. PR #427
   - see https://github.com/node-red/dashboard-evi/wiki/Creating-New-Dashboard-Widgets
